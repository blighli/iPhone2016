...
-(void) printmonth:(int)year mon:(int)mon{
    ...
    NSMutableString *monthStr = [PrintCalendar transformMonthToEnglish:mon];
    ...
    day = [ComputeDays daysOfUntilLastMonth:year mon:mon];
    ...
    //输出第二行开始所有的；
    int count = 0;
    for (; i < [[monthArray objectAtIndex:mon] intValue]; ) {
...
- (void) printyear:(int)year{
    ...
    int day1 = 0;
    //上一年距离第一年第一天的天数；
    day1 = [ComputeDays daysOfUntilLastMonth:year mon:1];
    ...
    //开始打印2月的第一行；
    int day2 = 0;
    day2 = [ComputeDays daysOfUntilLastMonth:year mon:2];
    ...
    //开始打印3月的第一行；
    int day3 = 0;
    day3 = [ComputeDays daysOfUntilLastMonth:year mon:3];
    ...
    while (flag1 || flag2 || flag3) {
        ...
        for (; true; ) {
            ...
            if (count1 == 7) {
                ...
                printf(" ");
                for (; true ; ) {
                    if (i2 >= ([ComputeDays isLeapYear:year] == true ? 29 : 28)) {
    ...
    int day4 = 0;
    //上一年距离第一年第一天的天数；
    day4 = [ComputeDays daysOfUntilLastMonth:year mon:4];
    ...
    //开始打印2月的第一行；
    int day5 = 0;
    day5 = [ComputeDays daysOfUntilLastMonth:year mon:5];
    ...
    //开始打印3月的第一行；
    int day6 = 0;
    day6 = [ComputeDays daysOfUntilLastMonth:year mon:6];
    ...
    int day7 = 0;
    //上一年距离第一年第一天的天数；
    day7 = [ComputeDays daysOfUntilLastMonth:year mon:7];
    ...
    //开始打印2月的第一行；
    int day8 = 0;
    day8 = [ComputeDays daysOfUntilLastMonth:year mon:8];
    ...
    //开始打印3月的第一行；
    int day9 = 0;
    day9 = [ComputeDays daysOfUntilLastMonth:year mon:9];
    ...
    int day10 = 0;
    //上一年距离第一年第一天的天数；
    day10 = [ComputeDays daysOfUntilLastMonth:year mon:10];
    ...
    //开始打印11月的第一行；
    int day11 = 0;
    day11 = [ComputeDays daysOfUntilLastMonth:year mon:11];
    ...
    //开始打印12月的第一行；
    int day12 = 0;
    day12 = [ComputeDays daysOfUntilLastMonth:year mon:12];
